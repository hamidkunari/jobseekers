<footer style="height: 480px;" class="site-footer">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <p style="color:white">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repellat quos rem ullam, placeat amet.</p>
            <p><a style="background-color: #38c172;" href="#" class="btn pill text-white px-4">Read More</a></p>
          </div>
          <div class="col-md-6">
            <div class="row">
              <div class="col-md-6">
                <h3 class="footer-heading mb-4 text-white">Quick Menu</h3>
                  <ul class="list-unstyled text-white">
                    ...
                    <li><a style="color:white" href="#">Approach</a></li>
                    <li><a style="color:white" href="#">Sustainability</a></li>
                    <li><a style="color:white" href="#">News</a></li>
              ...
              <div class="col-md-6">
                <h3 class="footer-heading mb-4 text-white">Categories</h3>
                  <ul class="list-unstyled">
                    <li><a style="color:white" href="#">Full Time</a></li>
                    <li><a style="color:white" href="#">Freelance</a></li>
                    <li><a style="color:white" href="#">Temporary</a></li>
                    <li><a style="color:white" href="#">Internship</a></li>
                  </ul>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-2">
            <div class="col-md-12"><h3 class="footer-heading mb-4 text-white">Social Icons</h3></div>
              <div class="col-md-12">
                <p>
                  <a style="color:white" href="#" class="pb-2 pr-2 pl-0"><span class="icon-facebook"></span></a>
                  <a style="color:white" href="#" class="p-2"><span class="icon-twitter"></span></a>
                  <a style="color:white" href="#" class="p-2"><span class="icon-instagram"></span></a>
                  <a style="color:white" href="#" class="p-2"><span class="icon-vimeo"></span></a>
        ...
        <div class="row pt-5 mt-5 text-center">
          <div class="col-md-12">
            ...
            Copyright &copy; <script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script>document.write(new Date().getFullYear());</script>  <a style="color:white" href="" target="_blank" >All Rights Reserved by JobFinder</a>
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
          </div>
